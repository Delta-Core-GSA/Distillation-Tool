...
if __name__ == "__main__":
    ...
    teacher_model_name = "google/electra-base-discriminator"
    student_model_name = "google/electra-small-discriminator"
    teacher_path = './models/pretrained/electra-base.pt'
    student_path = './models/pretrained/electra-small.pt'
    ...
    output_model_path = project.create_distillation_folder("electra-base-to-small", dataset_name)
